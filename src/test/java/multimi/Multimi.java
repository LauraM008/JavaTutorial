...
public class Multimi {
    ...
    //afisam nistr obiective turistice alaturi de orasele in care se afla
    //map = key - value

    public void obiectiveTuristice() {
        Map<String, String> obiective = new LinkedHashMap<>();
        obiective.put("Paris", "Eiffel Tower");
        obiective.put("Constanta", "Casino");
        obiective.put("Cairo", "Piramidele");
        ...
        for (String key : obiective.keySet()) {
            ...
            System.out.println("Obiectivul din care oras este: " + obiective.get(key));
        }
    }

    public void obiectiveTuristiceV3() {
        Map<String, List<String>> obiective = new LinkedHashMap<>();
        obiective.put("Paris", Arrays.asList("Turnul Eiffel", "Chamselise", "Louvre"));
        obiective.put("Constanta", Arrays.asList("Casino"));
        obiective.put("Cairo", Arrays.asList("Piramidele"));
        ...
        for (String key : obiective.keySet()) {
            System.out.println("Orasul curent este: " + key);
            System.out.println("Obiectivele din care oras sunt: " + obiective.get(key));
        }
    }
